...
export default function OrderManager() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'pending': return <Badge className="bg-amber-100 text-amber-700 border-amber-200">Chờ xác nhận</Badge>;
      case 'processing': return <Badge className="bg-blue-100 text-blue-700 border-blue-200">Đang xử lý</Badge>;
      case 'shipped': return <Badge className="bg-indigo-100 text-indigo-700 border-indigo-200">Đang giao</Badge>;
      case 'delivered': return <Badge className="bg-emerald-100 text-emerald-700 border-emerald-200">Đã hoàn thành</Badge>;
      case 'cancelled': return <Badge className="bg-rose-100 text-rose-700 border-rose-200">Đã hủy</Badge>;
                ...
                <tr key={order.id} className="hover:bg-gray-50/80 transition-colors group">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      >
                        <SelectTrigger className="w-32 h-8 text-[10px] font-bold uppercase tracking-widest rounded-lg">
                          <SelectValue />
                        </SelectTrigger>
