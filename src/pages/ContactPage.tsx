          ...
          <div className="container-luxury">
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              >
                ...
                <form className="bg-card rounded-lg p-6 shadow-subtle space-y-4">
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="phone" placeholder="0909 xxx xxx" />
                    </div>
                  </div>
              ...
              >
                ...
                <p className="text-muted-foreground mb-6">
                  OHOUSE luôn chào đón các đối tác tiềm năng. Hãy liên hệ với chúng tôi để khám phá 
                ...
                <div className="space-y-4">
                  {cooperationTypes.map((type, index) => (
                    <motion.div
                      ...
                      transition={{ delay: index * 0.1 }}
                      viewport={{ once: true }}
                      className="flex items-start gap-4 bg-card rounded-lg p-5 shadow-subtle hover:shadow-medium transition-shadow cursor-pointer group"
                    >
