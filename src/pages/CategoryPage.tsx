...
export default function CategoryPage() {
  ...
  return (
    <>
      <Helmet>
        <title>{`${pageTitle} | OHOUSE Nội Thất Cao Cấp`}</title>
        <meta name="description" content={`Khám phá bộ sưu tập ${pageTitle} sang trọng, hiện đại tại OHOUSE. Hàng nghìn mẫu thiết kế cao cấp giúp nâng tầm không gian sống của bạn.`} />
        <meta property="og:title" content={`${pageTitle} | OHOUSE`} />
        <meta property="og:description" content={`Bộ sưu tập ${pageTitle} cao cấp từ thương hiệu OHOUSE.`} />
          ...
          <div className="container-luxury">
            <div className="flex flex-col lg:flex-row gap-12 items-start">
              ...
              <div className="flex-1 min-w-0">
                <div className={cn(
                  "grid grid-cols-2 gap-2 md:gap-6 lg:gap-10",
