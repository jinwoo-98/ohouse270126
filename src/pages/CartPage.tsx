            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-1">
                <div className="bg-card rounded-lg p-6 shadow-subtle sticky top-24">
                  ...
                  <div className="flex gap-2 mb-6"><Input placeholder="Mã giảm giá" value={couponCode} onChange={(e) => setCouponCode(e.target.value)} /><Button variant="outline">Áp dụng</Button></div>
                  ...
                  <Button className="w-full mt-6 btn-hero">Thanh Toán <ArrowRight className="w-4 h-4 ml-2" /></Button>
