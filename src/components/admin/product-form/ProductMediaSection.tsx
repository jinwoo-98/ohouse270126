        ...
        <div className="grid lg:grid-cols-2 gap-10">
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-4">
              <Label className="text-[10px] font-bold uppercase text-muted-foreground">Ảnh đại diện chính (1:1)</Label>
              <ImageUpload 
            ...
            <div className="space-y-4">
              <Label className="text-[10px] font-bold uppercase text-muted-foreground">Ảnh kích thước (1:1)</Label>
              <ImageUpload 
                aspectRatio="aspect-square"
                value={formData.dimension_image_url} 
                onChange={(url) => setFormData({...formData, dimension_image_url: url as string})} 
              />
            </div>
          </div>
          <div className="space-y-4">
