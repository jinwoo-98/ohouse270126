    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button 
          variant="outline" 
          className={cn(
            // Mobile optimization: flex-1, h-12, text-[10px]
            "flex-1 min-w-0 h-12 px-2 text-[10px] font-bold uppercase tracking-normal border-border/60 hover:bg-secondary/50 justify-center text-center flex-col",
            // Desktop styles
