      ...
      <div className="bg-card">
        <div className="container-luxury">
          <div className="flex items-center justify-between h-12 md:h-14 gap-4">
            {/* Left: Search */}
            <div className="flex-1 flex items-center max-w-xs"> {/* Changed max-w-md to max-w-xs */}
              {/* Mobile Menu Button */}
              <button
            ...
            {/* Right: Icons */}
            <div className="flex-1 flex items-center justify-end gap-1 max-w-xs"> {/* Added max-w-xs here for symmetry */}
              {/* Mobile Search */}
              <button
