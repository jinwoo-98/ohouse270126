...
export function FloatingActions() {
  ...
  return (
    <>
      <div className="fixed bottom-32 right-6 md:right-8 z-[100] flex flex-col gap-3">
        {/* AI Chat Trigger Button - Ẩn nếu là trang admin */}
        {!isAdminPage && (
          <motion.button
      ...
      {/* AI Chat Window Interface - Chỉ hiển thị khi không phải trang admin */}
      {!isAdminPage && <AIChatWindow isOpen={isChatOpen} onClose={() => setIsChatOpen(false)} />}
    </>
  );
}