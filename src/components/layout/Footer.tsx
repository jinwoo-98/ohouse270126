...
export function Footer() {
  ...
  return (
    <footer className="bg-background text-charcoal overflow-hidden relative border-t border-border/40">
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row w-full lg:max-w-2xl gap-3">
              <div className="relative flex-1">
                <Input 
                  ...
                  required
                  className="bg-white border-border/60 text-charcoal h-12 rounded-xl focus:ring-primary pr-12 placeholder:text-muted-foreground/50"
                />
